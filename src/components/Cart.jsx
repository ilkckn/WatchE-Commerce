...
function Cart() {
  ...
  function removeFromCart(item) {
    dispatch({ type: "openModal", payload: "Are you sure you want to delete the product?" })
                    ...
                    <div className="productsTotalInfo">
                      <div className="image-info">
                        ...
                        <div className="name-price-quantity-buttons">
                          ...
                          <p className="productsQuantity">Quantity: {pro.quantity}</p>
                          <p className="productsPrice">Price: {pro.price}€ </p>
                        </div>
                      </div>
                        <div className="quantityControls">
                          <div className="inc-dec-button">
                            <button className="quantityButton" onClick={() => decreaseQuantity(pro)}>-</button>
                            <span className="quantity">{pro.quantity}</span>
                            <button className="quantityButton" onClick={() => increaseQuantity(pro)}>+</button>
                          </div>
                          <button className="cartRemove" onClick={() => removeFromCart(pro)}><HiMiniTrash /></button>
                        </div>
                    </div>
                  </li>
                ))}
        ...
        <div className="totalAmount-shipping">
          <div className="part1">
            ...
            <div className="shipping">
              <p>Shipping <span>"standard"</span></p>
              <span>free</span>
            </div>
            <div className="VAT">
              <p>vat</p>
          ...
          <div className="part3">
              ...
              <div className="security">
                <span><AiOutlineSecurityScan /></span>
                <p>Secure checkout</p>
              </div>
          </div>
        </div>
